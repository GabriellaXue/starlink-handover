...
def aggregate_data(bandwidth_frame, throughput_frame):
    ...
    bandwidth_frame['timestamp'] = (bandwidth_frame['timestamp'] // 1000)
    ...
    throughput_frame['timestamp_sec'] = (throughput_frame['timestamp'] // 1000)
    throughput_frame_bytes_agg = throughput_frame.groupby('timestamp_sec')['bytes'].sum()
    throughput_frame['timestamp'] = throughput_frame['timestamp'] / 1000
